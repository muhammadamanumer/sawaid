    ...
    // ==========================================
    // SAWAID DATABASE SEED SCRIPT
    // Last Updated: 11-Jan-2026 10:00 PM
    // ==========================================
    // This script initializes the Sawaid Appwrite database with all
    // collections, attributes, and indexes. Run this script to create
    ...
    const SCHEMA = [
        ...
        },
        {
            ...
            indexes: [
                { key: 'idx_slug', type: 'unique', attributes: ['slug'] },
                { key: 'idx_path_active', type: 'key', attributes: ['pathId', 'isActive'] },
