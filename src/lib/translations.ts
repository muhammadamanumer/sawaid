...
const translations: Record<Locale, any> = {
  en: {
    ...
    home: {
      heroTitle: "Sawaed Al-Islah Foundation — Building Generations of Reformers",
      heroSubtitle: "Empowering communities through education and humanitarian support",
      ...
      registerSponsor: "Register as Sponsor",
      ...
      pathsTitle: "Our Paths",
      pathsSubtitle: "Four main tracks driving our mission",
      quranVerse: "I only intend reform as much as I am able. And my success is not but through Allah.",
      quranReference: "(Hud: 88)",
      newsAndChallenges: "News & Challenges",
    ...
    campaignCard: {
        ...
        zakatSupported: "Zakat Supported",
        zakatNotSupported: "Zakat Not Supported",
    },
    paths: {
        title: "Our Paths",
        description: "Four main tracks driving our mission to build generations of reformers",
        educationEmpowerment: {
            title: "Education & Empowerment",
            description: "Providing quality education and skills training to empower communities",
        },
        sponsoringReformers: {
            title: "Sponsoring Reformers",
            description: "Supporting individuals committed to positive change in their communities",
        },
        educationalNurseries: {
            title: "Educational Nurseries",
            description: "Early childhood education programs nurturing the next generation",
        },
        generalReformPrograms: {
            title: "General Reform Programs",
            description: "Comprehensive initiatives addressing community development needs",
        },
        viewProjects: "View Projects",
        detail: {
            backToPath: "Back to Paths",
            mainPath: "Main Path",
            programs: "Programs",
            impactTitle: "Impact of This Path",
            impactDescription: "We are making a real difference through sustainable and effective programs",
            beneficiaries: "Beneficiaries",
            totalDonations: "Total Donations",
            volunteers: "Volunteers",
            programsTitle: "Programs & Projects",
            programsDescription: "Discover the programs and projects we run under this path",
            zakatSupported: "Zakat Supported",
            programProgress: "Program Progress",
            keyHighlights: "Key Highlights",
            sustainableImpact: "Long-term sustainable impact",
            transparentManagement: "Transparent project management",
            regularReports: "Regular progress reports",
            donateNow: "Donate Now",
            learnMore: "Learn More",
            bePartTitle: "Be Part of This Path",
            bePartDescription: "Help us achieve more by supporting the programs of this path",
            exploreOther: "Explore Other Paths",
            volunteerWithUs: "Volunteer With Us",
        },
    },
    notFound: {
        title: "Page Not Found",
        description: "It seems the page you're looking for doesn't exist or has been moved. Don't worry, you can explore our other pages below.",
        backToHome: "Back to Home",
        contactUs: "Contact Us",
        quickLinks: "Quick Links",
        searchSuggestion: "Or use the navigation menu above to find what you're looking for",
        links: {
            home: {
                title: "Home",
            ...
            paths: {
                title: "Our Paths",
                description: "Explore our main paths",
            },
            campaigns: {
                title: "Campaigns",
    ...
    volunteer: {
        ...
        formDateOfBirthLabel: "Date of Birth",
        formQualificationLabel: "Qualification",
        formCurrentOccupationLabel: "Current Occupation",
        formWeeklyHoursLabel: "Available Hours Per Week",
        formSkillsLabel: "Skills (Optional)",
        formSkillsPlaceholder: "List your relevant skills (e.g., teaching, fundraising, design, languages)",
        formVolunteerExperienceLabel: "Previous Volunteer Experience (Optional)",
        formVolunteerExperiencePlaceholder: "Tell us about your previous volunteer work",
        formPositionLabel: "Position of Interest",
        formMotivationLabel: "Why do you want to volunteer with us? (Optional)",
    ...
    about: {
      ...
      historyText1: "Founded in 2015 in Doha, Qatar, in response to the growing humanitarian crisis affecting millions of displaced individuals, Sawaed Al-Islah began as a small volunteer-driven initiative. What started with a handful of dedicated individuals has grown into an international movement with operations across multiple countries.",
  ...
  ar: {
    ...
    home: {
        heroTitle: "مؤسسة سواعد الإصلاح — بناء أجيال المصلحين",
        heroSubtitle: "تمكين المجتمعات من خلال التعليم والدعم الإنساني",
        ...
        donateNow: "تبرع الآن",
        donationFields: "مجالات التبرع",
        registerSponsor: "سجل كراعٍ",
        ...
        pathsTitle: "مساراتنا",
        pathsSubtitle: "أربعة مسارات رئيسية تقود مهمتنا",
        quranVerse: "إِنْ أُرِيدُ إِلَّا الْإِصْلَاحَ مَا اسْتَطَعْتُ وَمَا تَوْفِيقِي إِلَّا بِاللَّهِ",
        quranReference: "(هود: 88)",
        newsAndChallenges: "الأخبار والتحديات",
    ...
    campaignCard: {
        ...
        zakatSupported: "يمكن التبرع من أموال الزكاة",
        zakatNotSupported: "لا يمكن التبرع من أموال الزكاة",
    },
    paths: {
        title: "مساراتنا",
        description: "أربعة مسارات رئيسية تقود مهمتنا لبناء أجيال المصلحين",
        educationEmpowerment: {
            title: "التعليم والتمكين",
            description: "توفير تعليم عالي الجودة وتدريب على المهارات لتمكين المجتمعات",
        },
        sponsoringReformers: {
            title: "رعاية المصلحين",
            description: "دعم الأفراد الملتزمين بالتغيير الإيجابي في مجتمعاتهم",
        },
        educationalNurseries: {
            title: "الحضانات التعليمية",
            description: "برامج التعليم المبكر لرعاية الجيل القادم",
        },
        generalReformPrograms: {
            title: "برامج الإصلاح العامة",
            description: "مبادرات شاملة تعالج احتياجات تنمية المجتمع",
        },
        viewProjects: "عرض المشاريع",
        detail: {
            backToPath: "العودة إلى المسارات",
            mainPath: "مسار رئيسي",
            programs: "البرامج",
            impactTitle: "تأثير هذا المسار",
            impactDescription: "نحن نعمل على إحداث فرق حقيقي من خلال برامج مستدامة وفعالة",
            beneficiaries: "المستفيدين",
            totalDonations: "إجمالي التبرعات",
            volunteers: "المتطوعين",
            programsTitle: "البرامج والمشاريع",
            programsDescription: "تعرف على البرامج والمشاريع التي نديرها ضمن هذا المسار",
            zakatSupported: "يمكن التبرع من الزكاة",
            programProgress: "تقدم البرنامج",
            keyHighlights: "أبرز النقاط",
            sustainableImpact: "تأثير مستدام طويل الأجل",
            transparentManagement: "إدارة شفافة للمشروع",
            regularReports: "تقارير دورية منتظمة",
            donateNow: "تبرع الآن",
            learnMore: "اعرف المزيد",
            bePartTitle: "كن جزءًا من هذا المسار",
            bePartDescription: "ساعدنا في تحقيق المزيد من الإنجازات من خلال دعم برامج هذا المسار",
            exploreOther: "استكشف مسارات أخرى",
            volunteerWithUs: "تطوع معنا",
        },
    },
    notFound: {
        title: "عذراً، الصفحة غير موجودة",
        description: "يبدو أن الصفحة التي تبحث عنها غير متوفرة أو تم نقلها إلى موقع آخر. لا تقلق، يمكنك استكشاف صفحاتنا الأخرى أدناه.",
        backToHome: "العودة إلى الرئيسية",
        contactUs: "اتصل بنا",
        quickLinks: "روابط سريعة",
        searchSuggestion: "أو يمكنك استخدام قائمة التنقل في الأعلى للعثور على ما تبحث عنه",
        links: {
            home: {
            ...
            paths: {
                title: "مساراتنا",
                description: "استكشف مساراتنا الرئيسية",
            },
            campaigns: {
                title: "الحملات",
                description: "عرض الحملات النشطة",
            },
            donate: {
                title: "تبرع",
                description: "قدم تبرعاً",
            },
        },
    },
    campaigns: {
    ...
    donate: {
        ...
        form: {
            ...
            monthly: "تبرع شهري",
            amountTitle: "المبلغ (بالريال القطري)",
    ...
    volunteer: {
        ...
        formDateOfBirthLabel: "تاريخ الميلاد",
        formQualificationLabel: "المؤهل العلمي",
        formCurrentOccupationLabel: "الوظيفة الحالية",
        formWeeklyHoursLabel: "الساعات المتاحة أسبوعيًا",
        formSkillsLabel: "المهارات (اختياري)",
        formSkillsPlaceholder: "اذكر مهاراتك ذات الصلة (مثال: التدريس، جمع التبرعات، التصميم، اللغات)",
        formVolunteerExperienceLabel: "خبرة التطوع السابقة (اختياري)",
        formVolunteerExperiencePlaceholder: "أخبرنا عن تجربتك السابقة في التطوع",
        formPositionLabel: "الوظيفة المطلوبة",
        formMotivationLabel: "لماذا تريد التطوع معنا؟ (اختياري)",
    ...
    about: {
      ...
      historyTitle: "قصتنا",
      historyText1: "تأسست سواعد الإصلاح في عام 2015 في الدوحة، قطر، استجابةً للأزمة الإنسانية المتنامية التي تؤثر على ملايين الأفراد النازحين، وبدأت كمبادرة صغيرة يقودها المتطوعون. ما بدأ بحفنة من الأفراد المتفانين نما ليصبح حركة دولية تعمل في عدة دول.",
