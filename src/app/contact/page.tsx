    ...
    <div className="py-12 md:py-16">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          <div className="lg:col-span-3">
             <Card className="w-full shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl font-headline">{t('contact.formTitle')}</CardTitle>
              ...
              <CardFooter>
                <Button className="w-full bg-accent hover:bg-accent/90 text-accent-foreground">{t('contact.formSendButton')}</Button>
              </CardFooter>
            </Card>
          </div>
          <div className="lg:col-span-2 space-y-8">
            <div>
              <h2 className="text-2xl font-headline font-semibold mb-4">{t('contact.infoTitle')}</h2>
              <div className="space-y-4 text-muted-foreground">
                <div className="flex items-start gap-4">
                  <MapPin className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-foreground">{t('contact.hqTitle')}</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground">{t('contact.emailSupportTitle')}</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground">{t('contact.phoneSupportTitle')}</h3>
            ...
            <div>
              <h2 className="text-2xl font-headline font-semibold mb-4">{t('contact.followUsTitle')}</h2>
        ...
        <div className="mt-16 md:mt-24">
           <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl md:text-4xl font-headline font-bold">{t('contact.faqTitle')}</h2>
            <p className="max-w-2xl mx-auto text-lg text-muted-foreground">
           ...
           <Accordion type="single" collapsible className="w-full max-w-3xl mx-auto">
              {faqItems.map((item, index) => (
                <AccordionItem key={index} value={`item-${index}`}>
                  <AccordionTrigger className="text-lg text-left font-semibold hover:no-underline">{t(`faq.${item.id}.question`)}</AccordionTrigger>
