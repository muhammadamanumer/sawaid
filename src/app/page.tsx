...
import { 
  ArrowRight, Heart, Users, TrendingUp, DollarSign, 
  HandHeart, Megaphone, Share2, GraduationCap, 
  Droplets, Stethoscope, Clock, FileText, CheckCircle2
} from 'lucide-react';
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center text-center px-4 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto text-primary-foreground z-10">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-5 justify-center animate-fadeInUp animation-delay-400">
              <Button asChild size="lg" variant="accent" className="shadow-modern-xl hover:scale-105 transition-all">
                <Link href="/donate">{t('home.donateNow')}</Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="border-2 border-primary-foreground/80 text-primary-foreground bg-transparent hover:bg-primary-foreground/20 shadow-modern-lg backdrop-blur-sm hover:scale-105 transition-all">
        ...
        <section className="relative bg-gradient-to-br from-muted via-background to-muted py-20 overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 md:px-6">
             <h2 className="text-4xl md:text-5xl font-headline font-bold text-center mb-4 animate-fadeInUp">{t('home.impactTitle')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="group p-8 bg-background/80 backdrop-blur-sm rounded-2xl shadow-modern-lg hover:shadow-modern-xl transition-all duration-500 border border-border/50 hover:border-primary/30 animate-fadeInUp animation-delay-200 hover:-translate-y-2">
                ...
                <p className="text-5xl font-bold mt-2 bg-clip-text text-transparent bg-gradient-to-br from-primary to-primary-light">$1.2M+</p>
                <p className="text-muted-foreground mt-3 font-medium">{t('home.fundsRaised')}</p>
              </div>
              <div className="group p-8 bg-background/80 backdrop-blur-sm rounded-2xl shadow-modern-lg hover:shadow-modern-xl transition-all duration-500 border border-border/50 hover:border-primary/30 animate-fadeInUp animation-delay-300 hover:-translate-y-2">
                ...
                <p className="text-5xl font-bold mt-2 bg-clip-text text-transparent bg-gradient-to-br from-primary to-primary-light">50,000+</p>
                <p className="text-muted-foreground mt-3 font-medium">{t('home.peopleHelped')}</p>
              </div>
              <div className="group p-8 bg-background/80 backdrop-blur-sm rounded-2xl shadow-modern-lg hover:shadow-modern-xl transition-all duration-500 border border-border/50 hover:border-primary/30 animate-fadeInUp animation-delay-400 hover:-translate-y-2">
                ...
                <p className="text-5xl font-bold mt-2 bg-clip-text text-transparent bg-gradient-to-br from-primary to-primary-light">5,000+</p>
                <p className="text-muted-foreground mt-3 font-medium">{t('home.volunteers')}</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-destructive/10 text-destructive px-4 py-2 rounded-full mb-4 animate-fadeInUp">
                ...
                <span className="text-sm font-semibold uppercase tracking-wide">Time Sensitive</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-headline font-bold mb-4 animate-fadeInUp animation-delay-100">{t('home.urgentAppealsTitle')}</h2>
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="border-destructive/20 shadow-modern-xl hover:shadow-modern-2xl transition-all duration-500 overflow-hidden group animate-fadeInUp animation-delay-300">
                <div className="relative h-64 overflow-hidden">
                  {campaigns[0] && PlaceHolderImages.find(p => p.id === campaigns[0].image) && (
                    <Image
                      src={PlaceHolderImages.find(p => p.id === campaigns[0].image)!.imageUrl}
                      alt="Urgent campaign"
                      fill
                ...
                <CardHeader>
                  <CardTitle className="text-2xl">{t(`campaigns.${campaigns[0].slug}.title`)}</CardTitle>
                  <CardDescription className="text-base">{t(`campaigns.${campaigns[0].slug}.description`)}</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between text-sm mb-2">
                        <span className="font-semibold">${campaigns[0].currentAmount.toLocaleString()} raised</span>
                        <span className="text-muted-foreground">${campaigns[0].goal.toLocaleString()} goal</span>
                      </div>
                      <div className="w-full bg-muted rounded-full h-3 overflow-hidden">
                        <div 
                          className="h-full bg-gradient-to-r from-primary to-accent transition-all duration-500 rounded-full"
                          style={{ width: `${Math.min((campaigns[0].currentAmount / campaigns[0].goal) * 100, 100)}%` }}
                        />
                      </div>
                    </div>
        ...
        <section className="relative py-24 bg-background overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 md:px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-headline font-bold mb-4 animate-fadeInUp">{t('home.featuredCampaigns')}</h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto animate-fadeInUp animation-delay-100">
                Join us in making a lasting impact through these meaningful initiatives
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
              {featuredCampaigns.map((campaign, index) => (
                <div key={campaign.id} className="animate-fadeInUp" style={{ animationDelay: `${(index + 2) * 100}ms` }}>
                  <CampaignCard campaign={campaign} />
                </div>
              ))}
            </div>
             <div className="text-center mt-16 animate-fadeInUp animation-delay-500">
                <Button asChild variant="outline" size="lg" className="group shadow-modern-md hover:shadow-modern-lg">
                    <Link href="/campaigns">
        ...
        <section className="relative py-24 bg-gradient-to-br from-primary/5 via-background to-accent/5 overflow-hidden">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-headline font-bold mb-4 animate-fadeInUp">{t('home.waysToHelpTitle')}</h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto animate-fadeInUp animation-delay-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="group hover:shadow-modern-xl transition-all duration-500 hover:-translate-y-2 border-border/50 hover:border-primary/30 animate-fadeInUp animation-delay-200">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-xl">{t('home.ways.donate.title')}</CardTitle>
              ...
              <Card className="group hover:shadow-modern-xl transition-all duration-500 hover:-translate-y-2 border-border/50 hover:border-primary/30 animate-fadeInUp animation-delay-300">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-xl">{t('home.ways.volunteer.title')}</CardTitle>
                  <CardDescription className="text-sm leading-relaxed">
              ...
              <Card className="group hover:shadow-modern-xl transition-all duration-500 hover:-translate-y-2 border-border/50 hover:border-primary/30 animate-fadeInUp animation-delay-400">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-xl">{t('home.ways.fundraise.title')}</CardTitle>
                  <CardDescription className="text-sm leading-relaxed">
              ...
              <Card className="group hover:shadow-modern-xl transition-all duration-500 hover:-translate-y-2 border-border/50 hover:border-primary/30 animate-fadeInUp animation-delay-500">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-xl">{t('home.ways.spread.title')}</CardTitle>
                  <CardDescription className="text-sm leading-relaxed">
        ...
        <section className="relative py-24 bg-background overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 md:px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-headline font-bold mb-4 animate-fadeInUp">{t('home.storiesTitle')}</h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto animate-fadeInUp animation-delay-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <Card className="group hover:shadow-modern-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden animate-fadeInUp animation-delay-200">
                <div className="relative h-48 overflow-hidden">
                  {PlaceHolderImages.find(p => p.id === 'campaign-education-support') && (
                    <Image
                      src={PlaceHolderImages.find(p => p.id === 'campaign-education-support')!.imageUrl}
                  ...
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <p className="font-bold text-lg">{t('home.stories.education.name')}</p>
                    <p className="text-sm text-white/90">{t('home.stories.education.role')}</p>
                  </div>
                </div>
              ...
              <Card className="group hover:shadow-modern-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden animate-fadeInUp animation-delay-300">
                <div className="relative h-48 overflow-hidden">
                  {PlaceHolderImages.find(p => p.id === 'campaign-clean-water') && (
                    <Image
                      src={PlaceHolderImages.find(p => p.id === 'campaign-clean-water')!.imageUrl}
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <p className="font-bold text-lg">{t('home.stories.water.name')}</p>
                    <p className="text-sm text-white/90">{t('home.stories.water.role')}</p>
                  </div>
                </div>
                <CardContent className="pt-6">
                  <div className="flex items-start gap-2 mb-4">
              ...
              <Card className="group hover:shadow-modern-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden animate-fadeInUp animation-delay-400">
                <div className="relative h-48 overflow-hidden">
                  {PlaceHolderImages.find(p => p.id === 'campaign-medical-aid') && (
                    <Image
                      src={PlaceHolderImages.find(p => p.id === 'campaign-medical-aid')!.imageUrl}
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <p className="font-bold text-lg">{t('home.stories.medical.name')}</p>
                    <p className="text-sm text-white/90">{t('home.stories.medical.role')}</p>
                  </div>
                </div>
                <CardContent className="pt-6">
                  <div className="flex items-start gap-2 mb-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6 animate-fadeInUp">
                  <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full">
                    ...
                    <span className="text-sm font-semibold uppercase tracking-wide">100% Transparency</span>
                  </div>
                  <h2 className="text-4xl md:text-5xl font-headline font-bold">{t('home.transparencyTitle')}</h2>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold">Annual Financial Reports</p>
                        <p className="text-sm text-muted-foreground">Detailed breakdown of all funds and expenditures</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
                      ...
                      <div>
                        <p className="font-semibold">Real-Time Impact Tracking</p>
                        <p className="text-sm text-muted-foreground">See exactly how your donations create change</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Third-party verification of our operations</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative animate-fadeInUp animation-delay-200">
                  <div className="relative h-96 rounded-2xl overflow-hidden shadow-modern-xl">
                    {PlaceHolderImages.find(p => p.id === 'transparency-report') && (
                      <Image
                        src={PlaceHolderImages.find(p => p.id === 'transparency-report')!.imageUrl}
                  ...
                  <div className="absolute -bottom-6 -right-6 bg-accent text-accent-foreground p-6 rounded-xl shadow-modern-xl max-w-xs">
                    ...
                    <p className="text-sm">of donations go directly to programs</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="relative py-20 bg-gradient-to-br from-primary via-primary to-primary-dark overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center text-primary-foreground">
              <h2 className="text-3xl md:text-4xl font-headline font-bold mb-4 animate-fadeInUp">{t('home.newsletterTitle')}</h2>
              ...
              <form className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto animate-fadeInUp animation-delay-200">
                ...
                />
                <Button type="submit" size="lg" variant="accent" className="shadow-modern-lg">
